...
p11 = Post.create!(user_id: jimmy.id, image_url: "http://res.cloudinary.com/diy3hv57b/image/upload/v1462337631/sweet9.jpg")
...
c5 = Comment.create!(user_id: jimmy.id, post_id: p10.id, body: "Man this was delicious! Made it myself. Anyone want to buy?")
...
c8 = Comment.create!(user_id: jimmy.id, post_id: p19.id, body: "Look what kim made me this morning! Luckiest guy on the planet!")
